...
/* ---------------------------------------------------------------------
   ...
   If these variables aren't set, no email is sent — this function
   logs the code to the SERVER'S OWN terminal only (never to the HTTP
   response) so local development still works without real SMTP
   credentials. That log line is clearly marked and must not be
   mistaken for a production email path.
--------------------------------------------------------------------- */
